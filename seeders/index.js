...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'jyemtI7OVOsxG7i',
      'isDeleted':false,
      'username':'Fredrick23',
      'email':'Kiera_Bogisich@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Fredrick23' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'TdsTqwDCVOzoTvT',
      'isDeleted':false,
      'username':'Marcel_Bednar80',
      'email':'Kendall.Dare@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Marcel_Bednar80' }, userToBeInserted,  { upsert: true });
