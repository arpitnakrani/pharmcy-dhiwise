...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Camila_Nitzsche97',
      password: '1ZysppBdwNaZS9O',
      email: 'Emilia_Schmeler@hotmail.com',
      name: 'Patty Stroman',
      userType: 424,
      mobileNo: '(710) 963-2386',
      resetPasswordLink: {},
      loginRetryLimit: 461,
      loginReactiveTime: '2023-06-25T12:44:07.707Z',
      id: '630f08c920f2a51298cd3a26'
    });
  }
  catch (error) {
  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        ...
        'password':'6mqykXr_pGZKhUP',
        'email':'Christine_Kautzer@yahoo.com',
        'name':'Brett Gerlach',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(469) 345-6076',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Christine_Kautzer@yahoo.com', });
